...
- **crash/reset и adversarial-device тесты**;
- **случай C** ADR-0093: рестарт и повторная публикация, причём устаревшая
  capability клиента не должна молча перенаправляться на успешника;
