...
этот раздел — историческая запись. Единственное, что сейчас действительно ждёт
Project Architect, — формальное рассмотрение закрытия Stage 4C и Stage 4D,
и оно записано выше, в записи от 2026-09-17, а не здесь.
