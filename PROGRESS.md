...
**D. Phase 4 заблокирована на ADR-0055, ADR-0056, ADR-0057 (Proposed).** См.
запись выше. Ни один не реализуется до подписи: статус `Proposed`, строка
approval пустая, подделывать её нельзя.
