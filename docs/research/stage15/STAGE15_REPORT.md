...
10–11. Raw 3+21 1/2/4-worker samples and methodology are in `measurements/`; bootstrap/recovery evidence is bounded serialized mode, not a final runtime claim.
...
14–18. Both retain canonical text, typed IR verifier boundary, ownership/atomic model, unforgeable capabilities and driver operations; exact mappings are in the finalist reports.
...
31–32. Acceptance requires reconciliation of docs/05, docs/06 and stages; no source migration exists yet.
