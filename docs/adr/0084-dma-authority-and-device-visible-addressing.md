...
**Stage 4C-3 is decided by ADR-0086** (Accepted 2026-09-10). It rests on §4's
write-back mapping and on §5c's P2, P3 and P4 as premises of its
reference-profile argument — the conjunction is load-bearing there, and P4 in
particular is what makes a coherent consume edge possible at all — and it adds no
authority, no right and no operation to anything decided here. The list above is
recorded as it stood; one item of it now has its own decision.
