...
| records, tuples, enums, match | docs/39 §5; docs/40 §1/4 | Guide: Data | [data.tos](examples/data.tos) | missing variant: E1220 | grammar/match generated cases | Not implemented |
...
| structured parallelism | docs/39 §5; docs/41 §1–2 | Guide: Async/parallel | [parallel.tos](examples/parallel.tos) | abandoned child: E1401 | C002 + 1/2/N exercise | Not implemented |
| asynchronous tasks | docs/39 §5; docs/41 §1–2 | Guide: Async/parallel | [async.tos](examples/async.tos) | Bootstrap use: E1702 | async/profile generated cases | Not implemented |
