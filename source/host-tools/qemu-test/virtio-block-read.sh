...
echo "  used.len as the device reported it: $used_len bytes — recorded here, and"
echo "  forced to 513 for an accepted completion of this chain: §2.7.8.2 puts it"
echo "  at most the 513-byte device-writable extent, §2.7.8.3 puts it at least"
echo "  the 513 bytes this driver reads. Not a general VirtIO claim: len may"
echo "  still underestimate, and this driver then refuses instead of consuming."
