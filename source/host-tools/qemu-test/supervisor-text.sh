...
echo "  what it does *not* do here is create them: this module reads a policy and"
echo "  announces it. The typed creation path — a launch plan written through two"
echo "  nominal interfaces, sealed, and given to operation 19 — is proved from text"
echo "  in tests/integration/tests/capability_result.rs (ADR-0077)"
